...
function(ext)
{
     ...
     var descriptor = {
     blocks: [
              ["w", "kör %m.dualMotors %m.turnStyle %n sekunder",         "steeringControl",  "B+C", "frammåt", 3],
              [" ", "starta motor %m.whichMotorPort hastighet %n",              "startMotors",      "B+C", 100],
              [" ", "rotera motor %m.whichMotorPort hastighet %n by %n grader then %m.brakeCoast",              "motorDegrees",      "A", 100, 360, "brake"],
              [" ", "stoppa motorer %m.whichMotorPort %m.brakeCoast",                       "motorsOff",     "all", "brake"],
              [" ", "lysdiod %m.patterns",                                 "setLED",                 "green"],
     ...
     "dualMotors":       ["A+D", "B+C"],
     "turnStyle":        ["frammåt", "reverse", "right", "left"],
     "brakeCoast":       ["brake", "coast"],
     "lightSensorMode":  ["reflected", "ambient", "color"],
     "motorInputMode": ["position", "hastighet"],
     "gyroMode": ["angle", "rate"],
